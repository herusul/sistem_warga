# CHANGELOG Sistem Warga

> Catat setiap perubahan yang sudah dikerjakan. Format: tanggal | modul | perubahan | status.

| Tanggal | Modul | Perubahan | Status |
|---|---|---|---|
| 2026-09-23 | Docs | Pembuatan awal `docs/` (umum + 8 modul + template + changelog) | Selesai |
| 2026-09-23 | Aset | Tahap dokumen modul aset: usulan terisi, decision tabel baru, `modul-aset.md`, 3 skema ddl, `work/aset/` (kode menyusul) | Selesai (dokumen) |
